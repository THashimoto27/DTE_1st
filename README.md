...
The 1st step is to create an primitive human being who can act like an animal, and an primitive environment which has only a kind of food that is not depriciated, an final good that is regularly located. Also there is no other limitations or settings in the model.
